...
This section contains the metadata of the sample used in this analysis which includes the sample name , condition and type or batch effect if present.
...
#convert to ensembl ids when gene symbol is NA
names[which(is.na(names[,"names"])),"names"] = 0
for(i in (1:nrow(names)))
  if (names$names[i]=="0")
    
    names$names[i]<- rownames(names)[i]
