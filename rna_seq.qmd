...
pca <- plot  + ggtitle("PCA plot - Sample Distances") 
pca
...
3.  More clustering based on batch effect rather than on condition.
4.  Untreated_single didn't show much similarity as expected compared to paired reads
