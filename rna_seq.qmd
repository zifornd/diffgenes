...
execute:
  echo: false
pre-render: data_validation.R
post-render: output_validation.R
params:
  sample_data:
    - "./data/samples.tsv"
  counts_data:
...
### 4.Boxplot of gene expression values
...
output_files <- list(
    ...
    list(
        ...
        Description = "normalized counts file"
        ),
    list(
      File = "log counts",
        Link = "<a href='./results/logcounts.tsv'> log_counts </a>",
        Description = "log counts file"
    ),
    list(
    ...
    list(
      File = "DESeqTransform.rds",
        ...
        Description = "tranformed dds"
    ),
    list(
      File = "DESeqResults_Treated_vs_Untreated_.rds",
        Link = "<a href='./results/DESeqResults_Treated_vs_Untreated_.rds'> tranform_dds </a>",
        Description = "rds of treated vs untreated"
    ),
    list(
      File = "DESeqResults_Treated_vs_Untreated_.tsv",
        Link = "<a href='./results/DESeqResults_Treated_vs_Untreated_.tsv'> tranform_dds </a>",
        Description = "tsv of treated vs untreated"
    ),
    list(
      File = "pca plot",
        Link = "<a href='./rna_seq_files/figure-html/fig-pcaplot-1.png> tranform_dds </a>",
        Description = "pca"
    ),
    list(
      File = "heatmap_dist",
        Link = "<a href='./rna_seq_files/figure-html/fig-heatmap_distance-1.png'> HEATMAP_DIST </a>",
        Description = "heatmap_distance"
    ),
    list(
      File = "mds_plot",
        Link = "<a href='./rna_seq_files/figure-html/fig-mdsplot-1.png'> HEATMAP_DIST </a>",
        Description = "mds plot"
    ),
    list(
      File = "boxplot",
        Link = "<a href='./rna_seq_files/figure-html/fig-boxplot-1.png'> HEATMAP_DIST </a>",
        Description = "boxplot"
    ),
    ...
    list(
      File = "heatmap",
        Link = "<a href='./rna_seq_files/figure-html/fig-heatmap-1.png'> HEATMAP </a>",
        Description = "heatmap"
    )
...
DT::datatable(jsonlite::fromJSON(output_files),escape = FALSE)
